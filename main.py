...
Label(window,text='Developed By @DebadashMuduli:2022',font=('bold',12),fg='blue').pack(side=BOTTOM)
...
Button(window,text='Exit',font=('bold',10),bg='aqua',fg='black',command=close).place(x=400,y=100)
window.mainloop()